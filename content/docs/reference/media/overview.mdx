...
last_edited: '2024-08-15T03:59:34.150Z'
---
...
TinaCMS supports a range of file types, but you can also specify your own file types or limit the files types that can be uploaded.

[Read more about overriding the default accepted media types here](/docs/reference/media/override-default-media-types)
